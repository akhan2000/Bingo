...
LectureBingo.Repo.insert!(%LectureBingo.Games.Incident{title: "Boring
...
LectureBingo.Repo.insert!(%LectureBingo.Games.Incident{title: "J'accuse
Coward", description: "The professor is blatenly called a coward by one of
their students"})
LectureBingo.Repo.insert!(%LectureBingo.Games.Incident{title: "Language!",
description: "The professor yet again uses language heretofor not uttered in
the hallowed Duke lecture halls"})
LectureBingo.Repo.insert!(%LectureBingo.Games.Incident{title: "Imposter
...
LectureBingo.Repo.insert!(%LectureBingo.Games.Incident{title: "Switching
...
meager skills"})
LectureBingo.Repo.insert!(%LectureBingo.Games.Incident{title: "Slide
